...
const guideSections = [
  ...
  },
  {
    ...
    usage: [
      ...
      '날짜별 샘플 리스트를 엑셀로 다운로드할 수 있습니다.',
      '이미지 포함 엑셀은 매크로 사용 파일(.xlsm)로 다운로드됩니다.',
      '다운로드한 엑셀 파일을 열면 상단 보안 경고에서 콘텐츠 사용을 눌러야 이미지가 표시됩니다.',
    ],
  ...
  },
  {
    ...
    usage: [
      ...
      '이미지 포함 엑셀(.xlsm)을 다운로드할 수 있습니다.',
      '기존 이미지 없는 엑셀 다운로드는 현재 비활성화되어 있습니다.',
      '이미지 포함 엑셀 파일을 열면 상단 보안 경고에서 콘텐츠 사용을 눌러야 썸네일 이미지가 자동 생성됩니다.',
    ],
  ...
  },
  {
    ...
    usage: [
      ...
      '이미지 포함 엑셀(.xlsm)을 다운로드할 수 있습니다.',
      '기존 이미지 없는 엑셀 다운로드는 현재 비활성화되어 있습니다.',
      '엑셀 파일을 열면 상단 보안 경고에서 콘텐츠 사용을 눌러야 이미지가 표시됩니다.',
      '회차별 입고수량과 추가 행 수량이 엑셀에 반영됩니다.',
    ],
  ...
  },
  {
    ...
    role: '샘플 리스트, 발주서, 입고확인서를 엑셀 파일로 다운로드하는 기능입니다.',
    usage: [
      '샘플관리에서는 날짜별 샘플 리스트를 다운로드합니다.',
      '발주관리에서는 이미지 포함 발주서 엑셀(.xlsm)을 다운로드합니다.',
      '입고관리에서는 이미지 포함 입고확인서 엑셀(.xlsm)을 다운로드합니다.',
      '이미지 포함 엑셀은 매크로 사용 통합 문서(.xlsm) 형식입니다.',
      '파일을 열면 Excel 상단에 보안 경고가 표시될 수 있습니다.',
      '이미지를 표시하려면 반드시 콘텐츠 사용 버튼을 눌러야 합니다.',
      '콘텐츠 사용을 누르면 A열 이미지 URL을 기준으로 B열에 썸네일 이미지가 자동 생성됩니다.',
      '기존 이미지 없는 엑셀 다운로드 버튼은 현재 비활성화되어 있습니다.',
    ],
    note: '이미지 포함 엑셀은 Windows Excel 기준으로 가장 안정적으로 작동합니다.',
  },  
]
