...
const guideSections = [
  {
    ...
    note: '향후 오늘 처리할 업무, 최근 샘플, 입고 예정 건 등을 표시할 수 있습니다.',
  },
  {
    title: '대시보드',
    icon: BarChart3,
    role: '전체 샘플, 아이템카드, 발주, 입고 상태를 한눈에 확인하는 페이지입니다.',
    usage: [
      '상태별 수량을 확인합니다.',
      '장기 대기 항목을 확인합니다.',
      '병목 예상 구간을 확인합니다.',
    ...
    note: '업무 시작 시 가장 먼저 확인하면 좋은 페이지입니다.',
  },
  {
    title: '샘플관리',
    icon: ClipboardList,
      ...
      <div className="mx-auto max-w-6xl space-y-6">
        ...
        <section className="rounded-2xl bg-white p-5 shadow-sm">
          ...
          <div className="mt-4 rounded-xl bg-gray-50 p-4 text-sm text-gray-600">
            <p>
              기본 흐름은 샘플 등록 후 상태를 판단하고, 진행 상품은 아이템카드와
